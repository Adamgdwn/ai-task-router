...
Status: open
Status Updated: 2026-07-26T11:20:59-06:00
...
| Teaching-audit findings 1 and 2 are on `main` but undeployed | 2026-07-26T11:20:59-06:00 | Project Owner | Open | Two user-visible changes: Start Here now teaches before a task is described, using the three worked examples from the existing reviewed snapshot, and Past Choices now shows what each followed choice would cost metered, how it compares to the heaviest route offered, and what the whole log adds up to against taking the heaviest route each time. Production serves `a34d839` without them. They need a deploy on owner authorization, using `docs/2026-07-09-cloudflare-deploy-turnover.md`, which has now worked unchanged from the home network three times. One teaching-audit finding remains coder work and is listed in the active pathway's Next Handoff. |
