...
- Added Desktop Chunk D10 technical-preview desktop artifacts: manual GitHub Actions workflow for Windows/macOS/Linux artifacts, shared Tauri technical-preview bundle config, platform package scripts, SHA-256 checksum file generation, and docs that keep public desktop downloads held until platform trust gates pass.
