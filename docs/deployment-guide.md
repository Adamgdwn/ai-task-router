...
The app does not perform local AI tool discovery and never has. The desktop track that would have was abandoned on 2026-07-26; see [ADR-0002](decisions/adr-0002-abandon-desktop-track.md).
...
2. Use the D12 Old Skool AI hub handoff for page copy, cross-site links, and rollback language.
...
10. Confirm no provider calls, credentials, telemetry, hidden uploads, or computer-checking claims are present in the hosted web build.
...
- manual browser smoke test on wide and narrow viewports
