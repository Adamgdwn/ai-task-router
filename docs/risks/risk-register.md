...
- Owner: Project Owner
- Last reviewed: 2026-07-04T14:56:49-06:00
...
| R-004 | Future desktop app could feel invasive if it inspects local tools or folders without clear consent. | Medium | High | Desktop trust plan, confirmed D0 defaults, and ADR-0001 keep D2 limited to a Tauri shell spike. Native discovery remains blocked until trust-boundary design, explicit user approval, narrow checks, summary by default, clear reset, and governance review are documented. | Project Owner | Planned |
