...
- Owner: Project Owner
- Last reviewed: 2026-07-04T11:28:22-06:00
...
| R-004 | Future desktop app could feel invasive if it inspects local tools or folders without clear consent. | Medium | High | Desktop trust plan and D0 packet require no silent scan, explicit user approval, narrow checks, summary by default, clear reset, and owner confirmation before native discovery. | Project Owner | Planned |
| R-005 | Unsigned or poorly explained desktop installers could undermine user trust or trigger platform warnings. | Medium | High | Public desktop release blocked until signing/notarization/checksum path is documented, reviewed, and matched to the selected publisher identity. | Project Owner | Planned |
