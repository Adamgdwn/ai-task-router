...
- Owner: Project Owner
- Last reviewed: 2026-07-04T19:34:29-06:00
...
| R-007 | Public website or social links could launch before the web/PWA release and cybersecurity gates pass. | Medium | High | D7 release/security readiness packet holds public launch until E2E, dependency audit, no-secrets, no-hidden-network, HTTPS, service-worker, copy, smoke, and rollback checks pass. | Project Owner | Open |
| R-008 | Three independent public app copies could create service-worker, cache, version, and support drift across domains. | Medium | Medium | D7 recommends one canonical Cloudflare Pages app URL linked from `oldskoolai.com`, `guidedailabs.com`, and `guidedaijourney.com`; duplicate app deployments need explicit service-worker scope and rollback review. | Project Owner | Open |
