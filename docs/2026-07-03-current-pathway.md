...
Reference only as of 2026-07-04T19:34:29-06:00: the owner wants GitHub as the public source/release hub, Cloudflare as the hosting path, links from `oldskoolai.com`, `guidedailabs.com`, and `guidedaijourney.com`, and later sharing through YouTube, Facebook, and LinkedIn after completion and cybersecurity testing. The D7 recommendation is one canonical Cloudflare Pages app URL, with the three sites linking to it, not three independent app copies.
