...
export const screenDefinitions: ScreenDefinition[] = [
  ...
  },
  {
    ...
    title: "My AI Tools",
    stage: "Setup",
    summary: "Tell the app what AI helpers you already have on the shelf.",
    purpose: "Prepare an editable local tool list without connecting accounts or storing credentials.",
    placeholderState: "Future inventory rows will keep quick choices first and advanced details tucked away.",
  },
  {
    id: "source-permissions",
    label: "Information Comfort",
    title: "Information Comfort",
    stage: "Setup",
    summary: "Choose what kinds of information you are comfortable using.",
    purpose: "Keep privacy choices explicit without asking users to understand internal permission levels.",
    placeholderState: "Future controls will keep privacy language in front and routing details behind advanced drawers.",
  },
  {
    id: "policy-settings",
  ...
  },
  {
    ...
    summary: "Describe what you are trying to get done and what the finished result should feel like.",
    purpose: "Create a clear local task record before any options are generated.",
    placeholderState: "Future form fields will keep everyday wording while preserving routing validation.",
  },
  {
    id: "route-results",
    label: "Best Options",
