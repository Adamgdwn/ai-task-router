# 2026-07-03T11:49:34-06:00 - AI Bootstrap Rules
...
- Read `START_HERE.md` and follow the active plan named there, defaulting to `docs/2026-07-09-current-build-pathway.md`, for material implementation work, unclear scope, handoffs, or changes that affect the active plan.
